    ...
    public class MeteorTidal : ModNPC
    {
        ...
        public override void OnHitByItem(Player player, Item item, int damage, float knockback, bool crit)
        {
            ...
            else
            {
                ...
                Projectile.NewProjectile(npc.Center, _3, mod.ProjectileType<ProStarStardust>(), 240, 1f, npc.whoAmI, player.whoAmI);
            }
        }
        ...
        public override void OnHitPlayer(Player target, int damage, bool crit)
        {
            ...
            else
            {
                ...
                Projectile.NewProjectile(npc.Center, _3, mod.ProjectileType<ProStarStardust>(), 240, 1f, npc.whoAmI, target.whoAmI);
            }
        }
        #endregion
        ...
        public override void NPCLoot()
        {
            ...
            {
                Item.NewItem((int)npc.Center.X, (int)npc.Center.Y, npc.width, npc.height, mod.ItemType<StarFrame>(), Main.rand.Next(1, 3));
                ...
                if (Main.rand.Next(0, 1000) <= 0)
                {
                    ...
                    Item.NewItem((int)npc.Center.X, (int)npc.Center.Y, npc.width, npc.height, mod.ItemType<GalaxyLight>(), 1);
                }
                else
                {

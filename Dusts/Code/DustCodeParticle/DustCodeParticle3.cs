...
{
    public class DustCodeParticle3 : ModDust
    {
        ...
        public override bool Update(Dust dust)
        {
            ...
            if (dust.dustIndex == 1) Dust.NewDustDirect(dust.position, 1, 1, ModContent.DustType<DustCodeParticle4>(), 0, 0, 102, Color.Green, 1f);
            #endregion
            return false;
        }
    }
